...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # firstname = models.CharField(max_length=255, default="admin")
    # lastname = models.CharField(max_length=255, default="Nicole")
    ...
    objects = UserManager() # Helps us handle our objects of type user
